 ...
 *
 * Scale tensor strides are passed explicitly because scale tensors can be strided views
 * that do not share the packed KV data stride ratio.
...
#pragma unroll
    for (uint32_t local_d_base = 0; local_d_base < NUM_MMA_D_VO_PER_WARP;
      ...
      uint32_t sf_row0 = 0, sf_row1 = 0, sf_row2 = 0, sf_row3 = 0;
